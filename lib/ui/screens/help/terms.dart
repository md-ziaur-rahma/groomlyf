    ...
    <div id="mainwrapper">
        <div id="content">
            <section id="mainContent">
                ...
                <ul>
                    <li>
                        <p><strong>Application.kt</strong> means the software program provided by the Company downloaded by
                            You on any electronic device, named GroomLyfe</p>
                    </li>
                    <li>
                        <p><strong>Application.kt Store</strong> means the digital distribution service operated and
                            developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the
                            Application.kt has been downloaded.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Nation 6 Markting and Media,
                            LLC, 41 N Commons, Suite 106 / G.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Feedback</strong> means feedback, innovations or suggestions sent by You regarding
                    ...
                    <li>
                        <p><strong>In-app Purchase</strong> refers to the purchase of a product, item, service or
                            Subscription made through the Application.kt and subject to these Terms and Conditions and/or
                            the Application.kt Store's own terms and conditions.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Service</strong> refers to the Application.kt.</p>
                    </li>
                    <li>
                ...
                <p>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with
                    ...
                    collection, use and disclosure of Your personal information when You use the Application.kt or the
                ...
                <p>You represent and warrant that: (i) You have the legal right to use any credit or debit card(s) or
                ...
                <p>Your right to cancel an Order only applies to Goods that are returned in the same condition as You
                    received them. You should also include all of the products instructions, documents and wrappings.
                ...
                <ul>
                    ...
                    <li>The supply of Goods which are, after delivery, according to their nature, inseparably mixed with
                        other items.</li>
                    <li>The supply of digital content which is not supplied on a tangible medium if the performance has
                ...
                <p>We are constantly updating Our offerings of Goods on the Service. The Goods available on Our Service
                ...
                <h2>Payments</h2>
                <p>All Goods purchased are subject to a one-time payment. Payment can be made through various payment
                ...
                <p>The Application.kt may include In-app Purchases that allow you to buy products, services or
                    Subscriptions.</p>
                <p>More information about how you may be able to manage In-app Purchases using your Device may be set
                    out in the Application.kt Store's own terms and conditions or in your Device's Help settings.</p>
                <p>In-app Purchases can only be consumed within the Application.kt. If you make a In-app Purchase, that
                    In-app Purchase cannot be cancelled after you have initiated its download. In-app Purchases cannot
                    be redeemed for cash or other consideration or otherwise transferred.</p>
                <p>If any In-app Purchase is not successfully downloaded or does not work once it has been successfully
                    downloaded, we will, after becoming aware of the fault or being notified to the fault by You,
                    investigate the reason for the fault. We will act reasonably in deciding whether to provide You with
                    a replacement In-app Purchase or issue You with a patch to repair the fault. In no event will We
                    ...
                    time and without significant inconvenience to You, We will authorize the Application.kt Store to refund
                    You an amount up to the cost of the relevant In-app Purchase. Alternatively, if You wish to request
                    a refund, You may do so by contacting the Application.kt Store directly.</p>
                <p>You acknowledge and agree that all billing and transaction processes are handled by the Application.kt
                    Store from where you downloaded the Application.kt and are governed by that Application.kt Store's own
                    terms and conditions.</p>
                <p>If you have any payment related issues with In-app Purchases, then you need to contact the
                    Application.kt Store directly.</p>
                <h1>Promotions</h1>
                ...
                <p>If You participate in any Promotions, please review the applicable rules as well as our Privacy
                    policy. If the rules for a Promotion conflict with these Terms, the Promotion rules will apply.</p>
                <h1>User Accounts</h1>
                ...
                <ul>
                    ...
                    <li>Nudity is prohibited at all times in the app.Doing so the users account may receive a warning or
                        have your account terminated without a notification. Don’t DO IT.</li>
                </ul>
                <p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether
                    ...
                    exposed to content that You may find offensive, indecent, incorrect or objectionable, and You agree
                    that under no circumstances will the Company be liable in any way for any content, including any
                    errors or omissions in any content, or any loss or damage of any kind incurred as a result of your
                    use of any content.</p>
                <h2>Content Backups</h2>
                <p>Although regular backups of Content are performed, the Company do not guarantee there will be no loss
                ...
                <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted
                    ...
                    email at dmca@groomlyfe.com and include in Your notice a detailed description of the alleged
                    infringement.</p>
                ...
                <p>You can contact our copyright agent via email at dmca@groomlyfe.com.
                ...
                <p>You assign all rights, title and interest in any Feedback You provide the Company. If for any reason
                ...
                <p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use
                    of the Service. Your use of the Application.kt may also be subject to other local, state, national, or
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="https://groomlyfe.com/terms"
                            rel="external nofollow noopener" target="_blank">https://groomlyfe.com/terms</a></li>
                </ul>
